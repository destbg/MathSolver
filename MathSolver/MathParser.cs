...
public static class MathParser
{
    ...
    {
        return Parse(equation, null, BracketType.None, []);
    }
    ...
    public static MathExpression Simplify(MathExpression expression)
    {
        switch (expression.Type)
        {
            case MathExpressionType.Condition:
            {
                ...
                ConditionMathExpression newExpression = new(conditionExpression.IsEqual, leftExpression, rightExpression, ifTrueExpression, ifFalseExpression);
            ...
            case MathExpressionType.Unary:
            {
                ...
                UnaryMathExpression newExpression = new(leftOperand, rightOperand, unaryExpression.Symbol, unaryExpression.Bracket, unaryExpression.SuffixSymbols, unaryExpression.Coefficient);
            ...
            case MathExpressionType.Single:
            {
                ...
                SingleMathExpression newExpression = new(operand, singleExpression.Bracket, singleExpression.SuffixSymbols, singleExpression.Coefficient);
    ...
    internal static MathExpression Parse(string equation, string? coefficient, BracketType bracketType, IReadOnlyList<MathSuffixSymbol> suffixSymbols)
    {
        ...
        EquationToMathExpressionConveter converter = new(expressions, coefficient, bracketType, suffixSymbols);
    ...
    {
        EquationToMathExpressionConveter converter = new(expressions, null, BracketType.None, []);
